                        ...
                        <tr>
                            ...
                            <td>
                                  <div class="btn-group btn-group-sm">
                                    <a href="index.php?page=view_order&id=<?= $row['id_order']; ?>" class="btn btn-default"><i class="fas fa-eye"></i></a>
                                    <a href="index.php?page=cost_approval&id=<?= $row['id_order']; ?>" class="btn btn-default"><i class="fas fa-dollar-sign"></i></a>
